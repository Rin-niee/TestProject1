...
- Если в проект добавятся внешние зависимости, убедитесь, что они указаны в `TestProject1.csproj`.
- Если нужны конкретные инструкции по настройке локального окружения или покрытию кода — добавлю по запросу.
